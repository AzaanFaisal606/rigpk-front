...
import type { ModelBrand, ModelCategory } from "@/lib/models";

// Single-colour brand marks (Simple Icons, CC0), drawn in currentColor so they
// sit white on the maroon menu wells like the transparent prebuilt thumbnails.
const BRAND_PATHS: Record<ModelBrand, string> = {
  nvidia:
...
export function CategoryIcon({ category }: { category: ModelCategory }) {
  const Icon = category === "gpu" ? MonitorPlay : Cpu;
  return <Icon aria-hidden size={52} strokeWidth={1.75} color="white" />;
}
