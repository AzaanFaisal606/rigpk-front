    ...
    >
      ...
      <defs>
        <pattern id="dots" x="0" y="0" width="6" height="6" patternUnits="userSpaceOnUse">
          <circle cx="3" cy="3" r="0.8" fill="#7c3aed" opacity="0.18" />
        </pattern>
      </defs>
      ...
      {/* Power button */}
      <circle cx="86" cy="21" r="5" fill="none" stroke="#7c3aed" strokeWidth="1.5" />
      <circle cx="86" cy="21" r="2" fill="#7c3aed" />
      ...
      {/* GPU fans */}
      <circle cx="50" cy="127" r="5" fill="none" stroke="#7c3aed" strokeWidth="1.2" />
      <circle cx="70" cy="127" r="5" fill="none" stroke="#7c3aed" strokeWidth="1.2" />

      {/* RAM stick hints */}
      <rect x="95" y="50" width="6" height="30" fill="#7c3aed" opacity="0.5" />
      <rect x="103" y="50" width="6" height="30" fill="#7c3aed" opacity="0.35" />
