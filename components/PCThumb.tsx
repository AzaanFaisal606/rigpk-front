...
export default function PCThumb({ angle = 0, scale = 1 }: Props) {
  return (
    ...
    >
      ...
      {/* Case outline */}
      <rect x="20" y="10" width="80" height="160" fill="none" stroke="var(--line-art)" strokeWidth="2.5" />

      {/* Front panel top strip */}
      <rect x="20" y="10" width="80" height="22" fill="var(--line-art)" />
      ...
      {/* Drive bays */}
      <rect x="30" y="40" width="28" height="6" fill="none" stroke="var(--line-art)" strokeWidth="1.2" />
      <rect x="30" y="52" width="28" height="6" fill="none" stroke="var(--line-art)" strokeWidth="1.2" />
      ...
      {[0,1,2,3,4,5].map(i => (
        <line
          ...
          stroke="var(--line-art)" strokeWidth="0.8" strokeDasharray="3 3"
        />
      ))}

      {/* GPU bracket */}
      <rect x="30" y="120" width="60" height="14" fill="none" stroke="var(--line-art)" strokeWidth="1.5" />
      {/* GPU fans */}
      ...
      {/* Bottom strip */}
      <rect x="20" y="158" width="80" height="12" fill="var(--line-art)" />
    </svg>
  );
}
